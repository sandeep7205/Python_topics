    ...
    for input_data in input_content:
       ...
       # handle invalid/missing data
        ...
        try:
            ...
            traceback.print_exc()
            return_dict['invalid_data_cnt']+= 1
    print(f"\n\nCSV source: {return_dict['csv_cnt']} || JSON source: {return_dict['json_cnt']} || Combined records: {(return_dict['csv_cnt'] + return_dict['json_cnt'])}\n\n")
    return return_dict
    ...
    with open(json_file_path, "r") as read_file:
        try:
            ...
            if add_source_flag == 1:
                ...
                # get_data = list(map(lambda d: d | {"source":"json"}, get_data['expenses']))
